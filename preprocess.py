...
def main():
  ...
  parser.add_argument('--base_dir', default=os.path.expanduser('~/mimic2/tacotron'))
  parser.add_argument('--mrs_dir', required=False)
  parser.add_argument('--mrs_username', required=False)
  parser.add_argument('--output', default='training')
  parser.add_argument(
      '--dataset', required=True, choices=['amy', 'blizzard', 'ljspeech', 'kusal', 'mailabs','mrs', 'kss']
  )
