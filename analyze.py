...
#     for i in (data):
#         for o in Korean(i.split("|")[3]):
#             # print(type(o))
#             if 'korean.Korean.Syllable' in str(type(o)):
#                 if o.phoneme_onset in phonemes:
#                     phonemes[o.phoneme_onset] += 1

#                 else:
#                     phonemes[o.phoneme_onset] = 1

#                 if o.phoneme_nucleus in phonemes:
#                     phonemes[o.phoneme_nucleus] += 1

#                 else:
#                     phonemes[o.phoneme_nucleus] = 1

#                 if o.phoneme_coda in phonemes and o.phoneme_coda != None:
#                     phonemes[o.phoneme_coda] += 1

#                 elif o.phoneme_coda != None:
#                     phonemes[o.phoneme_coda] = 1

#     phonemes = OrderedDict(sorted(phonemes.items(), key=lambda t: t[0])) 
#     print(phonemes)
...
# # python3 analyze.py --train_file_path=tacotron/training/train.txt --save_to=tacotron/visuals --cmu_dict_path=cmudict-0.7b
# # python3 analyze.py --train_file_path=training/train.txt --save_to=visuals --cmu_dict_path=cmudict-0.7b
...
def plot_phonemes(train_path, cmu_dict_path, save_path):
    ...
    data = ""
    phonemes = {}
    with open("tacotron/training/train.txt", "r") as f:
        data = f.read()[:-1].split("\n")
